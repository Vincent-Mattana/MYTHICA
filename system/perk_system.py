...
class PerkSystem:
    ...
    def check_level_up(self, character: Character) -> bool:
        ...
        if character.experience >= next_level_exp:
            character.level += 1
            # Grant 5 attribute points and 1 skill point per level
            if not hasattr(character, 'attribute_points'):
            ...
            # Update max HP and mana for new level
            ...
            character.max_mana = character._calculate_max_mana()
            # Grant full mana on level up
