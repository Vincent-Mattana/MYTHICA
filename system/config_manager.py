...
class ConfigManager:
    ...
    def get_display_setting(self, setting: str) -> bool:
        """Get a display setting value."""
        try:
            return self.config.getboolean('Display', setting)
        except (configparser.NoSectionError, configparser.NoOptionError):
            # Return default value if setting doesn't exist
            return self.default_config.get('Display', {}).get(setting, 'false').lower() == 'true'
